...
> ✅ **Resolución completa (verificada): [[final-tema-06-resolucion]]**
...
$$f : [0, 1] \to \mathbb{R} : f(x) = 1 - x,\quad f(x) = f(x + 1)$$
...
$$u(0, t) = u(1, t) = 0 \quad \text{y} \quad u(x, 0) = e^{-x} \sen(x)$$

b) Desarrollar un esquema de diferencias finitas implícito con 4 nodos internos si

$$u_x(0, t) = u(1, t) = 0 \quad \text{y} \quad u(x, 0) = x^2$$

## Ejercicio 4

Hallar la Transformada de Fourier de $f(t) = e^{-2|t| + 1}$ si $0 \le t \le 1$, $f(t) = 0$ en otro punto.
