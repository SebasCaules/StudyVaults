---
title: "Sesión de Estudio — Unidad 2"
type: examen
unidades: [2]
fuentes: []
...
# Sesión de Estudio — Unidad 2: Organización del Estado
...
### Pregunta 1: Verdadero o Falso — Poder Ejecutivo
...
### Pregunta 2: Completar — Duración del Mandato Presidencial
...
**Comentario:**  
Correcto según el art. 94 de la [[constitucion-nacional|Constitución Nacional]]. El mandato es de 4 años, y es renovable **consecutivamente una sola vez** (máximo 2 mandatos consecutivos). Después de dos mandatos consecutivos, debe mediar al menos un mandato sin ocupar la presidencia.

---

### Pregunta 3: Desarrollo Corto — Derechos y Garantías Constitucionales
...
**Garantías:** Son los **mecanismos de protección** para que esos derechos se respeten. Ej: El habeas corpus es garantía del derecho a la libertad; el juicio previo es garantía del derecho de defensa.
...
### Pregunta 4: Múltiple Choice — Última Reforma Constitucional

**Enunciado:**  
¿Cuál es la última reforma constitucional que tuvo Argentina?
...
**Comentario:**  
Correcto. La reforma de 1994 fue la última reforma constitucional argentina. Fue muy importante porque:
- Introdujo el art. 75 inc. 22: **jerarquía constitucional** a tratados de derechos humanos (Pacto de San José, Pacto Internacional de Derechos Civiles y Políticos, etc.)
- Permitió la reelección presidencial consecutiva (limitada a dos términos)
- Amplió derechos de tercera generación (ambiente, consumidor, etc.)

---

### Pregunta 5: Verdadero o Falso — Iglesia como Persona Jurídica
...
### Pregunta 6: Múltiple Choice — Composición del Congreso Nacional

**Enunciado:**  
El Congreso Nacional está compuesto por:
...
**Comentario:**  
Correcto. El [[poder-legislativo|Congreso Nacional]] es **bicameral** (dos cámaras):

- **Cámara de Senadores:** 3 senadores por provincia + 3 por CABA = 72 senadores. Mandato de 6 años, renovación cada 2 años (1/3 de los senadores).
- **Cámara de Diputados:** Representación proporcional según población. ~257 diputados. Mandato de 4 años, renovación cada 2 años (la mitad).

---

### Pregunta 7: Desarrollo Corto — División de Poderes
...
- **[[poder-judicial|Poder Judicial]]:** Administra justicia, interpreta leyes, controla constitucionalidad de actos, garantiza derechos.

Este sistema de **pesos y contrapesos** (checks and balances) evita concentración de poder.

---

### Pregunta 8: Múltiple Choice - Selección Múltiple — Atribuciones del Poder Legislativo

**Enunciado:**  
¿Cuáles de las siguientes son **atribuciones del Poder Legislativo**? (Marca todas las correctas)
...
### Pregunta 9: Caso Práctico — División de Poderes en Infraestructura

**Enunciado:**  
El gobierno necesita invertir dinero en infraestructura de transporte. Analiza este caso según la [[constitucion-nacional|Constitución]]:

- a) ¿Qué poder debe intervenir para aprobar los fondos?
...
- **PJ:** Controla legalidad (si hubo corrupción, irregularidades en licitación, violación de derechos de terceros, etc.). Puede anular actos del PE si son inconstitucionales.

Este es un **ejemplo real** de cómo funcionan los pesos y contrapesos.

---

### Pregunta 10: Desarrollo — Federalismo vs Sistema Unitario
...
| Aspecto | Federal | Unitario |
|---------|---------|----------|
| **Distribución de poder** | Poder compartido: Nación + Provincias | Poder centralizado en Nación |
| **Autonomía provincial** | Alta — provincias tienen competencias propias | Baja — provincias subordinadas |
| **Legislación** | Provincias dictan leyes sobre materias propias | Leyes nacionales unifican todo |
| **Ejemplo real** | Argentina, EE.UU., Brasil | Uruguay, Francia |

**¿Por qué Argentina eligió federalismo?**
- Territorios amplios y dispersos (difícil gobernar centralizadamente)
- Diferentes realidades regionales (necesidad de autonomía)
- Equilibrio de poder entre grandes provincias como Buenos Aires

**Facultades delegadas vs Concurrentes:**

- **Facultades delegadas (art. 121 CN):** Las que las provincias cedieron a la Nación. Solo la Nación las ejerce. Ej: Relaciones exteriores, defensa, aduanas.
