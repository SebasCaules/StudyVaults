---
title: "Sesión de Estudio — Unidad 1"
type: examen
unidades: [1]
fuentes: []
...
# Sesión de Estudio — Unidad 1: Introducción al Derecho
...
### Pregunta 2: Completar — Pirámide Jurídica de Kelsen
...
6. Reglamentos y regulaciones administrativas
7. Actos individuales (contratos)

---

### Pregunta 3: Desarrollo Corto — Validez vs Vigencia
...
Un ejemplo: Una ley derogada puede ser válida (fue creada correctamente) pero no vigente (ya no se aplica).

---

### Pregunta 4: Múltiple Choice — Fuentes del Derecho

**Enunciado:**  
¿Cuál de las siguientes NO es considerada una **[[fuentes-del-derecho|fuente del derecho]]**?
...
### Pregunta 5: Verdadero o Falso — Common Law
...
### Pregunta 6: Completar — Derecho Público y Privado
...
### Pregunta 7: Desarrollo Corto — Deber Ser vs Ser
...
### Pregunta 8: Múltiple Choice Selección Múltiple — Características de Norma Jurídica

**Enunciado:**  
¿Cuáles de los siguientes enunciados son características de una **[[norma-juridica|norma jurídica]]**? (Marca todas las correctas)

- a) Es obligatoria
- b) Está impuesta por el Estado
- c) Orienta la conducta hacia la justicia
...
1. Obligatoria (no voluntaria)
2. Impuesta por el Estado
3. Orienta la conducta hacia la justicia
4. Prevé sanciones ante incumplimiento

La opción (d) es incorrecta porque las normas jurídicas no son voluntarias.

---

### Pregunta 9: Caso Práctico — Ley vs Costumbre

**Enunciado:**  
Un ingeniero diseña una plataforma de software. En el país donde opera, hay costumbre entre las empresas de no pedir consentimiento explícito para recopilar datos de usuarios, pero hace poco se aprobó una **nueva ley** que prohíbe esto.
...
### Pregunta 10: Desarrollo — Derecho Natural vs Positivo
...
|---------|-----------------|------------------|
| **Definición** | Principios universales, inmutables, anteriores al Estado | Normas creadas y vigentes dictadas por el Estado |
| **Origen** | Razón, naturaleza humana, principios éticos | Voluntad estatal, procedimiento legislativo |
| **Vigencia** | Siempre válido (teóricamente) | Vigente mientras el Estado lo mantenga |
| **Ejemplo** | Derecho a la vida, libertad, dignidad | Códigos, leyes, decretos |

**Importancia para la sociedad:**  
Ambos son importantes. El D. Natural proporciona **legitimidad** (¿por qué obedecemos?), el D. Positivo proporciona **certeza jurídica** (sabemos qué se puede y qué no).

**Ejemplo:**
- **D. Natural:** "Todos tienen derecho a la vida" (principio universal)
- **D. Positivo:** "El Código Penal castiga el homicidio con 8-25 años de prisión" (norma vigente)
...
Preparado para **Unidad 2: Organización del Estado** (10 preguntas)
