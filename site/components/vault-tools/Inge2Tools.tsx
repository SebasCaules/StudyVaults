  ...
  const tools: Tool[] = [
    {
      ...
      tone: "accent",
      verb: "See progress",
      desc: "Your starting point: how well you know each unit, how ready you are for the resit and where to focus.",
    ...
    },
    {
      ...
      tone: "def",
      verb: "Review",
      desc: "Memorise the key concepts with active recall and spaced repetition: the app surfaces what you struggle with most.",
      node: <Flashcards />,
    },
    {
      key: "tradeoffs",
      ...
      tone: "def",
      verb: "Train",
      desc: "Every architecture decision gives up something in exchange for something else. Train what you gain and what you give up in each one.",
    ...
    },
    {
      ...
      tone: "method",
      verb: "Practise",
      desc: "Hundreds of questions filterable by unit and difficulty, with explanations, to measure what you really know.",
      node: <QuizBank />,
    },
    {
      key: "mechanism",
      label: "Which mechanism?",
      group: "Practise",
      icon: "gears",
      tone: "method",
      verb: "Decide",
      desc: "We give you a design problem and you pick the mechanism that solves it: train the judgment the exam looks for.",
    ...
    },
    {
      ...
      tone: "method",
      verb: "Detect",
      desc: "Learn to smell bad design: read a case and spot the anti-pattern before it becomes a problem.",
    ...
    },
    {
      ...
      tone: "caution",
      verb: "Sit",
      desc: "A full exam in the real format, case by case, to test yourself under exam conditions.",
    ...
    },
    {
      ...
      tone: "formula",
      verb: "Solve",
      desc: "Write quality-attribute scenarios (performance, security…) with the stimulus–response–measure template.",
      node: <QualityAttributeScenarios />,
    },
    {
      key: "add",
      label: "ADD: worked case",
      group: "Solve",
      icon: "blueprint",
      tone: "formula",
      verb: "Walk through",
      desc: "Walk through an attribute-driven design (ADD) step by step on a real case, decision by decision.",
      node: <AddWalkthrough />,
    },
    {
      key: "cap",
      ...
      tone: "formula",
      verb: "Classify",
      desc: "Under a network partition, does the system choose consistency or availability? Classify cases with CAP and PACELC.",
      poster: PosterCap,
      node: <CapClassifier />,
    },
    {
      ...
      tone: "formula",
      verb: "Calculate",
      desc: 'How many "nines" your system delivers: compute availability in series, in parallel and the yearly downtime.',
    ...
    },
    {
      ...
      tone: "theorem",
      verb: "Draw",
      desc: "A board to sketch component and deployment diagrams, like the ones you have to draw in the exam.",
      node: <DiagramBoard />,
    },
    {
      key: "styles",
      ...
      tone: "example",
      verb: "Explore",
      desc: "A catalogue of architectural styles (layers, microservices, events…): when to use each and what it implies.",
      node: <StyleCatalog />,
    },
    {
      key: "security",
      ...
      tone: "example",
      verb: "Explore",
      desc: "Security tactics and the threats they mitigate: authentication, encryption, auditing and friends, close at hand.",
    ...
    },
    {
      ...
      tone: "example",
      verb: "Explore",
      desc: "The 23 classic design patterns explained with their intent, structure and example usage.",
      node: <PatternCatalog />,
    },
    {
      key: "decision",
      ...
      tone: "example",
      verb: "Decide",
      desc: "Describe your problem and the guide leads you to the right GoF pattern: a compass so you never go blank.",
      node: <WhichPattern />,
    },
    {
      key: "checklist",
      ...
      tone: "example",
      verb: "Review",
      desc: "The checklist to review your design before handing it in and not lose points to the usual slips.",
  ...
  return (
    <ToolkitShell
      ...
      launcher={{
        ...
        pattern: "grid",
        variant: "grid",
        dek: "Everything to arrive ready for the resit, laid out as a study plan: map your progress, learn and practise the concepts, sit a mock exam, and keep the solving tools and the reference close at hand.",
        meta: (
          <>
